/**
 * [Mozilla Readability (2015)](https://github.com/mozilla/readability)
 * 
 ...
 * @param {number} [options.minContentLength=140] - Minimum length of content to be considered valid
 * @param {number} [options.minScore=20] - Minimum score for content to be considered valid
 * @param {number} [options.minTextLength=25] - Minimum length of text to be considered valid
 * @param {number} [options.retryLength=250] - Length to retry content extraction if initial attempt fails

...
/**
 * JS-PyTorch is a neural net matrix mult library with GPU.js using PyTorch API syntax.
 * @class torch
 * @see {@link https://eduardoleao052.github.io/js-pytorch/site/index.html|JS-PyTorch}
...
function load(model, loadedData) {

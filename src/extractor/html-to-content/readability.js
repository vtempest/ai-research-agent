/**
 * @fileoverview
 * Extracts article content from HTML documents with Readability.js
 * using  regex patterns, cleaning HTML, scoring nodes by paragraphs 
 * and id/class names, selecting the top candidate, and cleaning HTML.
 * 
 * @param {HTMLDocument} doc DOM Object document to parse.
 * @param {Object}       options The options object.
 * @author [Mozilla (2015-)]https://github.com/mozilla/readability
 * @author Arc90 Inc (2010) [Readability - An Arc90 Lab Experiment (2010)](https://www.youtube.com/watch?v=jnn1D5UOmlU)
 *    [History](https://en.wikipedia.org/wiki/Readability_(service))
 * @license Apache-2.0
 */

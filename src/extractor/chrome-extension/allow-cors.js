 ...
 * header of all requests to enable cross-domain requests to scrape data from other domains in frontend JS,
 * which means no proxy server is needed and web apps have Browser App functionality and can turn any data 
 *  into an API. CORS is voluntarily enforced by browser frontends.

...
- Domain-Speific Keyphrase Extraction - This can be used to find unique, domain-specific keyphrases in a doc or set of docs. Using noun Ngrams we can find repeated phrases that are unique to that document's field, as opposed to common phrases in all docs.

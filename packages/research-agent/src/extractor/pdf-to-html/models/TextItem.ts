// @ts-nocheck
/**
 * @fileoverview Model representing a single item of text in a PDF document.
 * Stores spatial information and font details.
 */
/**
 * @module research/extractor/pdf-to-html/models/TextItem

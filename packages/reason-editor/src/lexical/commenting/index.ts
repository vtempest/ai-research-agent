/**
 * @fileoverview Logic for managing comments and threads in the editor.
 * Provides a CommentStore for state management and collaboration support.
 */
...
/**
 * Creates a new thread object containing comments.
 */
...
/**
 * Store that manages comments and their synchronization (including collaborative).
 */
...
/**
 * React hook for consuming and subscribing to the comment store.
 * @param {CommentStore} commentStore - The comment store instance.
 * @returns {Comments} The current list of comments and threads.
 */

/**
 * @fileoverview Defines the CSS class mapping for various Lexical nodes and editor states.
 * These classes are used by the Lexical engine to style the editor content.
 */
...
/**
 * The primary editor theme mapping Lexical node types to their corresponding CSS classes.
 */

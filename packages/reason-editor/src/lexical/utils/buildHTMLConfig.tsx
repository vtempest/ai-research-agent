/**
 * @fileoverview Utility for building Lexical's HTMLConfig, which handles DOM import/export.
 * Includes custom handling for pasting text with formatting.
 */
...
/**
 * Builds the HTML configuration for the editor.
 */

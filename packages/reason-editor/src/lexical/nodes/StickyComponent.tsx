/**
 * @fileoverview React component for rendering and interacting with sticky notes in the Lexical editor.
 * Includes support for dragging, color changes, and nested collaborative editing.
 */
...
/**
 * The main Sticky component that handles rendering, dragging, and internal state.
 * @param {Object} props - Component props.
 * @param {number} props.x - The horizontal coordinate of the sticky note.
 * @param {number} props.y - The vertical coordinate of the sticky note.
 * @param {NodeKey} props.nodeKey - The unique Lexical node key.
 * @param {'pink' | 'yellow'} props.color - The background color of the sticky note.
 * @param {LexicalEditor} props.caption - The nested Lexical editor for the note content.
 * @returns {JSX.Element} The rendered sticky note component.
 */

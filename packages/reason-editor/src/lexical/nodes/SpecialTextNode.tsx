/**
 * @fileoverview Lexical node for representing special text entities, often used for highlighting or bracketed text.
 */
...
/** @noInheritDoc */
/**
 * Node for representing special text formatted as an entity.
 * Often used to hold bracketed content that should be treated as a single unit or have specific styling.
 */

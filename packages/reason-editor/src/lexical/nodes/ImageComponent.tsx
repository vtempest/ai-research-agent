/**
 * @fileoverview React component for rendering and interacting with images in the Lexical editor.
 * Includes support for resizing, captions, and collaborative editing.
 */
...
function LazyImage({
  ...
  const loadedStatus = status as { error: false; width: number; height: number };
  ...
  const calculateDimensions = () => {
    ...
    const naturalWidth = loadedStatus.width;
    const naturalHeight = loadedStatus.height;
...
/**
 * The main Image component that handles rendering, selection, resizing, and captions.
 * @param {Object} props - Component props.
 * @param {string} props.src - The image source URL.
 * @param {string} props.altText - Alternative text for the image.
 * @param {NodeKey} props.nodeKey - The unique Lexical node key.
 * @param {'inherit' | number} props.width - The display width of the image.
 * @param {'inherit' | number} props.height - The display height of the image.
 * @param {number} props.maxWidth - The maximum allowed width for the image.
 * @param {boolean} props.resizable - Whether the image can be resized by the user.
 * @param {boolean} props.showCaption - Whether to display the caption editor.
 * @param {LexicalEditor} props.caption - The nested Lexical editor for the caption.
 * @param {boolean} props.captionsEnabled - Whether captions are globally enabled.

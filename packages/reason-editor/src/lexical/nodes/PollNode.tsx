/**
 * @fileoverview Lexical node for representing interactive polls.
 * Extends DecoratorNode to render a React component within the editor.
 */
...
/**
 * Lexical node representing a poll.
 * Uses a React component (`PollComponent`) for rendering.
 */
...
/**
 * Creates a new PollNode.
 * @param {string} question - The poll question.
 * @param {Options} options - The initial poll options.
 * @returns {PollNode} The created node.
 */
...
/**
 * Checks if a Lexical node is a PollNode.
 * @param {LexicalNode | null | undefined} node - The node to check.
 * @returns {boolean} True if the node is a PollNode.
 */

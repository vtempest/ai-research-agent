/**
 * @fileoverview React component for rendering and interacting with polls in the Lexical editor.
 */
...
/**
 * The main Poll component that displays the question and a list of options.
 * @param {Object} props - Component props.
 * @param {string} props.question - The poll question text.
 * @param {Options} props.options - The list of poll options.

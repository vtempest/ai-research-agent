/**
 * @fileoverview React component for picking and displaying date and time within a Lexical node.
 * Uses `react-day-picker` for date selection and `floating-ui` for the popover.
 */
...
/**
 * The main DateTime component that renders a pill and a date picker popup.
 * @param {Object} props - Component props.
 * @param {Date | undefined} props.dateTime - The current date and time value.
 * @param {NodeKey} props.nodeKey - The unique Lexical node key.
 * @returns {JSX.Element} The rendered date time pill and picker.
 */

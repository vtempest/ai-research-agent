/**
 * @fileoverview Plugin for handling image insertion, dragging, and dropping in the Lexical editor.
 */
...
/**
 * Dialog body for inserting an image via a URL.
 */
...
/**
 * Dialog body for inserting an image via a file upload.
 */
...
/**
 * Dialog for selecting and inserting an image (via URL or local file).
...
/**
 * Plugin that enables image support, including drag and drop.
 * @param {Object} props - Component props.
 * @param {boolean} [props.captionsEnabled] - Whether image captions are enabled.

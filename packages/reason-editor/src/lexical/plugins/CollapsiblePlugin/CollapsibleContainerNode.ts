/**
 * @fileoverview Lexical node representing the container for collapsible content.
 * Extends ElementNode and renders as a <details> element (or a <div> on Chrome).
 */
...
/**
 * Node that contains a title and content section, allowing the content to be toggled.
 */
...
/**
 * Creates a new CollapsibleContainerNode.
 * @param {boolean} isOpen - The initial opened state.
 * @returns {CollapsibleContainerNode} The created node.
 */
...
/**
 * Checks if a Lexical node is a CollapsibleContainerNode.
 * @param {LexicalNode | null | undefined} node - The node to check.
 * @returns {boolean} True if the node is a CollapsibleContainerNode.
 */

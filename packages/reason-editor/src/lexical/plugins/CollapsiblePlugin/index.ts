/**
 * @fileoverview Plugin that enables collapsible content sections (accordion-style).
 * Manages the insertion and enforcement of the collapsible node structure.
 */
...
/**
 * Plugin that registers collapsible nodes and commands for inserting collapsible sections.

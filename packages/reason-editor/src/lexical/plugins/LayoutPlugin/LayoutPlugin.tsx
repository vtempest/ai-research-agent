/**
 * @fileoverview Plugin for managing multi-column layouts within the editor.
 * Handles the registration of layout-related commands and enforcement of node structure.
 */
...
/**
 * Plugin that registers commands for inserting and updating multi-column layouts.

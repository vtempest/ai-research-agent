...
/**
 * Formats the current selection as a paragraph.
...
/**
 * Formats the current selection as a heading of the specified size.
 * @param {LexicalEditor} editor - The editor instance.
 * @param {string} blockType - The current block type.
 * @param {HeadingTagType} headingSize - The desired heading tag (h1, h2, h3).
 */
 ...
 * @param {LexicalEditor} editor - The editor instance.
 * @param {boolean} skipRefocus - Whether to skip refocusing the editor.
 */

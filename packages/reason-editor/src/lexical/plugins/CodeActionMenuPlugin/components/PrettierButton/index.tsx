/**
 * @fileoverview Button component for formatting code content using Prettier.
 */
...
/**
 * Button that handles formatting the code block content using Prettier standalone.
 */

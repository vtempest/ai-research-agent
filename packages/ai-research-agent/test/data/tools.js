...
async (params) => {
    ...
    if (params.query !== undefined) bodyData.query = params.query;
    if (params.chat_history !== undefined) bodyData.chat_history = params.chat_history;
    if (params.article !== undefined) bodyData.article = params.article;

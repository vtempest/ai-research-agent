import { R as Runnable, g as BaseOutputParser, B as BaseChain, h as BaseLanguageModel } from "./index-DBwqUQFA.mjs";
class BasePromptTemplate extends Runnable {
  ...
  static async deserialize(data) {
    switch (data._type) {
      case "prompt": {
        const { PromptTemplate } = await import("./prompt-C5FL7SZO.mjs").then((n) => n.p);
      ...
      case "few_shot": {
        const { FewShotPromptTemplate } = await import("./few_shot-Db4c0ziH.mjs");
...
//# sourceMappingURL=llm_chain-BTfz7Eh4.mjs.map

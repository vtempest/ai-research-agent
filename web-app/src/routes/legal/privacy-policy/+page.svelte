<script>
    ...
    var APP_EMAIL_HTML = APP_EMAIL.replace('@','<span style="display:none;">&#8203;</span>&#64;')
...
<body>
    ...
    <ol>
        ...
        <li>
            ...
            <p>We use Usage Data to tailor features and content to you, run analytics and better understand user interaction with the Services. For more information on how we use Tracking Technologies and your choices, see the section below, Cookies and Other Tracking Technologies.</p>
        ...
        <li>
            ...
            <p>You may opt out of information collection for AI, which would prohibit us from using your search information to improve our AI models in your settings page if you are logged into the Services. If you delete your account, we will delete your personal information from our servers within 30 days. Please contact us at the email listed below to request deletion.</p>
        </li>
        ...
        <li>
            ...
            <p>The specific business or commercial purposes for which we collect your personal information and the categories of sources from which we collect your personal information are described in the section above, Collection and Use Your Information. We only use and disclose sensitive personal information for the purposes specified in the CCPA. The criteria we use to determine how long to retain your personal information is described in the section above, Data Security and Retention.</p>
            ...
            <h3>Selling and/or Sharing of Personal Information</h3>
        ...
        <li>
            ...
            <p>Should you have any questions about our privacy practices or this Privacy Notice, please email us at {@html APP_EMAIL_HTML}</p>
        </li>
    </ol>
</body>

...
(PaginationContent as any).displayName = "PaginationContent";

const PaginationItem = React.forwardRef<HTMLLIElement, React.ComponentProps<"li">>(({ className, ...props }, ref) => (
  <li ref={ref} className={cn("", className)} {...props} />
));
(PaginationItem as any).displayName = "PaginationItem";
...
(PaginationEllipsis as any).displayName = "PaginationEllipsis";

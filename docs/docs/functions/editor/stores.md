[ai-research-agent](../index.md) / editor/stores
...
[`Readable`](stores.md#readablet)&lt;`undefined` \| `HTMLElement`&gt;
...
[`Readable`](stores.md#readablet)&lt;`null` \| [`EditorRange`](document/EditorRange.md#editorrange)&gt;

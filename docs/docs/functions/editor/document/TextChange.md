[ai-research-agent](../../index.md) / editor/document/TextChange
...
`null` \| [`default`](TextDocument.md#default)
...
`null` \| [`EditorRange`](EditorRange.md#editorrange)
...
`null` \| `number` \| [`EditorRange`](EditorRange.md#editorrange)
